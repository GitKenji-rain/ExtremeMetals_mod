...
public class RecipebuilderSteamLathe implements RecipeBuilder {
    ...
    public static RecipebuilderSteamLathe create(Ingredient ingredient, Item result, int count) {
        return new RecipebuilderSteamLathe(ingredient, result, count);
    }

    public RecipebuilderSteamLathe(Ingredient ingredient, Item result, int count) {
    ...
    @Override
    public RecipebuilderSteamLathe unlockedBy(String name, CriterionTriggerInstance criterion) {
        this.advancement.addCriterion(name, criterion);
        return this;
    }

    @Override
    public RecipebuilderSteamLathe group(@Nullable String groupName) {
        return this;
    }
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation id) {
        ...
        consumer.accept(new Result(id, this.ingredient, this.result, this.count,
                this.advancement, id.withPrefix("recipes/steam_lathe/")));
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            ...
            return ExtremeMetalsAddRecipes.STEAM_LATHE_SERIALIZER.get();
        }
