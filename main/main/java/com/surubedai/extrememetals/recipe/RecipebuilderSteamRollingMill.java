...
public class RecipebuilderSteamRollingMill implements RecipeBuilder {
    ...
    public static RecipebuilderSteamRollingMill create(Ingredient ingredient, Item result, int count) {
        return new RecipebuilderSteamRollingMill(ingredient, result, count);
    }

    public RecipebuilderSteamRollingMill(Ingredient ingredient, Item result, int count) {
    ...
    @Override
    public RecipebuilderSteamRollingMill unlockedBy(String name, CriterionTriggerInstance criterion) {
        this.advancement.addCriterion(name, criterion);
        return this;
    }

    @Override
    public RecipebuilderSteamRollingMill group(@Nullable String groupName) {
        return this;
    }
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation id) {
        ...
        consumer.accept(new Result(id, this.ingredient, this.result, this.count,
                this.advancement, id.withPrefix("recipes/steam_rolling/")));
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            ...
            return ExtremeMetalsAddRecipes.STEAM_ROLLING_SERIALIZER.get();
        }
